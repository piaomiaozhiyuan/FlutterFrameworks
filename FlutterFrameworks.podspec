#
# Be sure to run `pod lib lint FlutterFrameworks.podspec' to ensure this is a
...
Manager FlutterFrameworks.
  ...
  s.author           = { 'piaomiaozhiyuan' => 'piaomiaozhiyuan@163.com' }
  ...
  # s.resource_bundles = {
  #   'FlutterFrameworks' => ['FlutterFrameworks/Assets/*.png']
  # }
